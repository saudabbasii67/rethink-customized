...
//        // Check if the "su" binary exists.
//        val suBinary = File("/system/bin/su")
//        if (suBinary.exists()) {
//            return true
//        }
//
//        // Check if the "su" binary is accessible.
...
//        val user = try {
//            Runtime.getRuntime().exec("whoami").inputStream.bufferedReader().readLine()
//        } catch (e: Exception) {
//            null
//        }
//        if (user == "root") {
...
//        }
//
//        // Check if the "su" permission is granted to the app.
//        val grantResults = PackageManager.PERMISSION_GRANTED
//        if (ContextCompat.checkSelfPermission(
//                this,
//                Manifest.permission.ACCESS_SUPERUSER
//            ) == grantResults) {
//            return true
//        }
//
